...
class BalancesResponse(BaseModel):
    ...
    readiness: dict[ExchangeName, ExchangeReadiness] = Field(default_factory=dict)
...
def _not_configured_reason(exchange: ExchangeName) -> str:
...
async def balances(
    ...
    readiness: dict[ExchangeName, dict[str, object]] = {
        exchange_name: {"ready": False, "reason": "not requested"}
